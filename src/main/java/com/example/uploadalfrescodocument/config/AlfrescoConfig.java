...
public class AlfrescoConfig {
    ...
    @Value("${bidder.dispute.folder.name}")
    public String bidderDisputeFolderName;

    @Value("${bidder.tender.folder.name}")
    public String bidderTenderFolderName;


    @Value("${bidder.document.folder.name}")
    public String bidderDocumentFolderName;

    @Value("${dispute.document.folder.name}")
    public String disputeDocumentFolderName;
